...
{
    public static WorkflowBuilder AddPassthroughRequestHandler<TRequest, TResponse>(this WorkflowBuilder builder, ExecutorRegistration source, ExecutorRegistration filter, string? id = null)
    {
    ...
    public static WorkflowBuilder AddExternalRequest<TRequest, TResponse>(this WorkflowBuilder builder, ExecutorRegistration source, string? id = null)
        => builder.AddExternalRequest(source, out RequestPort<TRequest, TResponse> _, id);

    public static WorkflowBuilder AddExternalRequest<TRequest, TResponse>(this WorkflowBuilder builder, ExecutorRegistration source, out RequestPort<TRequest, TResponse> inputPort, string? id = null)
    {
    ...
    public static WorkflowBuilder AddExternalRequest<TRequest, TResponse>(this WorkflowBuilder builder, ExecutorRegistration source, RequestPort<TRequest, TResponse> inputPort)
    {
    ...
    public static Workflow CreateWorkflow()
    {
        ...
        ExecutorRegistration subworkflow = CreateSubWorkflow().AsExecutor("ResourceWorkflow");
