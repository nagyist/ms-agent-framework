...
{
    private readonly List<ExecutorRegistration> _executors = [];
    ...
    public SwitchBuilder AddCase<T>(Func<T?, bool> predicate, params IEnumerable<ExecutorRegistration> executors)
    {
    ...
    /// <returns></returns>
    public SwitchBuilder WithDefault(params IEnumerable<ExecutorRegistration> executors)
    {
        Throw.IfNull(executors);
    ...
    internal WorkflowBuilder ReduceToFanOut(WorkflowBuilder builder, ExecutorRegistration source)
    {
